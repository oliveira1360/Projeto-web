 ...
 */
@Component
class MsgConverterUrlToQrCode :
    AbstractGenericHttpMessageConverter<URI>(
        MediaType("image", "png"),
    ) {
    override fun supports(clazz: Class<*>): Boolean = clazz.kotlin.isSubclassOf(URI::class)
    ...
    ): URI = throw NotImplementedException("Does not support conversion of Image to URI")
