...
interface RepositoryLobby: Repository<Lobby> {
    fun createLobby(name: Name, hostId: Int, maxPlayers: Int, inviteCode: String): Lobby
    fun findAllLobbies(): List<Lobby>
    fun findLobbyById(id: Int): Lobby?
    fun findByInviteCode(code: String): Lobby?
    fun isUserInLobby(userId: Int, lobbyId: Int): Boolean
    fun countPlayers(lobbyId: Int): Int
    fun addPlayer(lobbyId: Int, userId: Int)
    fun removePlayer(lobbyId: Int, userId: Int)
